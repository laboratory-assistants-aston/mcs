...
CREATE TABLE "recource_type"
(
    "recource_type_id"   INTEGER          NOT NULL,
    "recource_type_name" VARCHAR(255)     NOT NULL,
    "recource_type_cost" DOUBLE PRECISION NOT NULL
);
ALTER TABLE  "recource_type"  ADD PRIMARY KEY ("recource_type_id");
...
ALTER TABLE "passports" ADD PRIMARY KEY ("passport_number");
CREATE TABLE "status"
(
    "status_id"   INTEGER NOT NULL,
...
(
    ...
    "resident_id"        INTEGER          NOT NULL,
    "operation_sum"      DOUBLE PRECISION NOT NULL,
...
ALTER TABLE "balance_history" ADD PRIMARY KEY ("balance_history_id");
ALTER TABLE "booking_resources"
    ADD CONSTRAINT "booking_resources_resource_id_foreign" FOREIGN KEY ("resource_id") REFERENCES "resources" ("resource_id");
ALTER TABLE "booking_resources"
    ADD CONSTRAINT "booking_resources_resident_id_foreign" FOREIGN KEY ("resident_id") REFERENCES "residents" ("resident_id");
ALTER TABLE  "sending_notifications"
...
ALTER TABLE  "resources"
    ADD CONSTRAINT "resources_resource_type_id_foreign" FOREIGN KEY ("resource_type_id") REFERENCES "recource_type" ("recource_type_id");
ALTER TABLE "resources"
    ADD CONSTRAINT "resources_status_id_foreign" FOREIGN KEY ("status_id") REFERENCES "status" ("status_id");
